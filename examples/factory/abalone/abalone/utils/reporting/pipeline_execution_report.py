...
class PipelineExecutionReport(BaseReport):
    ...
    def _get_pipeline_definition(self, pipeline: Any) -> Dict[str, Any]:
        # get pipeline definition as dict
        logging.info("fetching definition")
        try:
            definition_report = Dict[str, Any](json.loads(pipeline.definition()))
    ...
    def _get_execution_definition(self, execution: Any) -> Dict[str, Any]:
        # get the pipeline execution definition as dict
        logging.info("fetching execution definition")
        try:
            execution_definition_report = Dict[str, Any](execution.describe())
    ...
    def _get_execution_steps(self, execution: Any) -> List[Dict[str, Any]]:
        # list the steps in the execution as a list of dicts
        logging.info("fetching steps")
        try:
            execution_steps_report = List[Dict[str, Any]](execution.list_steps())
        except (AttributeError, TypeError, ValueError) as exc:
    ...
    def _get_lineage(
        self, sagemaker_session: Any, execution_steps_report: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            lineage_report = []
            for execution_step in reversed(List[Dict[str, Any]](execution_steps_report)):
    ...
    def _get_evaluation(self, sagemaker_session: Any, eval_file_uri: S3LocationURI) -> Dict[str, Any]:
        ...
        try:
            ...
            evaluation_report = Dict[str, Any](json.loads(evaluation_json))
        except (AttributeError, TypeError, ValueError) as exc:
    ...
    def _enhance_json(self, json_report: ReportContent) -> ReportContent:
        ...
        def enhance_date(step: Dict[str, Any], key: str) -> None:
            try:
